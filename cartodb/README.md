...
This manually maintained reference table contains information on the GPS tags and the individual birds these are mounted on. Thus far, there is a one-one relationship between device and bird. We are currently monitoring 3 species:

vernacular name | scientific name | family | project name | published dataset
--- | --- | --- | --- | ---
...
project_name | string | Shortname for the research project for which these tags are used.
