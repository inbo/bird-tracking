...
All data are released to the public domain under a [CC0 waiver](https://creativecommons.org/publicdomain/zero/1.0/). This allows you to use these freely, but we would appreciate it if you [follow these norms](http://www.inbo.be/en/norms-data-use).
