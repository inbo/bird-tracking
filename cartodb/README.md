...
* Via twitter: [@LifeWatchINBO](https://twitter.com/LifeWatchINBO)
* By [creating an issue](https://github.com/LifeWatchINBO/bird-tracking/issues/new) to this repository.
* Or by contacting the involved researchers: [Eric Stienen](eric.stienen@inbo.be) for `gull` and [Anny Anselin](anny.anselin@inbo.be) for `wmh`
...
We are currently monitoring 3 species:
