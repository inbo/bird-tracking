...
versioned_doi <- "https://doi.org/10.5281/zenodo.5070086"
start_year <- 2018
end_year <- 2020
```
...
dataset <-
  ...
  add_movebank_resource("reference-data", ref_data, keys = TRUE) %>%
  add_movebank_resource("gps", gps_data, keys = TRUE) %>%
  add_movebank_resource("acceleration", acc_data, keys = TRUE)
