...
movebank_ref_data <-
  ...
  mutate(
    ...
    `deployment-end-type` = case_when(
      str_detect(tolower(track_session_remarks), "dead") ~ "dead",
      str_detect(tolower(track_session_remarks), "predated") ~ "dead",
      str_detect(tolower(track_session_remarks), "defect") ~ "equipment failure",
      str_detect(tolower(track_session_remarks), "malfunction") ~ "equipment failure",
      TRUE ~ NA_character_
    ),
    ...
    `manipulation-type` = case_when(
      str_detect(track_session_remarks, "VOC") ~ "manipulated other",
