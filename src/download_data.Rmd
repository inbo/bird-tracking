...
individuals_sql <- glue_sql(read_file(here("sql", "individuals.sql")), .con = con)
```
...
```{r}
write.csv(individuals, file = here("data", "interim", "individuals.csv"), na = "", row.names = FALSE, fileEncoding = "UTF-8")
```
