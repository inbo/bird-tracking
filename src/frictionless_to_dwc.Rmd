...
paragraphs <- unlist(strsplit(description_full, "(</p>)", perl = TRUE))
description <- paste0(paragraphs[1], "</p>", paragraphs[2], "</p>")
```

3. Remove the "additional notes" paragraph: "This version adds alt-project-id to the reference-data a ..."
# zenodo$metadata$addition_descriptions (see eml$dataset$abstract)
4. Verify if `![CDATA[<span></span>` needs to be kept for the IPT #eml$dataset$intellectualRights$para
