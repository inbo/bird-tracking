...
Map the source data to [Extended Measurement Or Facts](http://rs.gbif.org/extension/obis/extended_measurement_or_fact.xml). The mapping is done in SQL:
...
```{r}
write.csv(dwc_occurrence_detections, file = paste0("../data/processed/dwc_occurrence_detections_", device_info_serial, ".csv"), na = "", row.names = FALSE, fileEncoding = "UTF-8")
```
