...
LBBG_TEXEL - Herring gulls (Larus fuscus, Laridae) in Texel (the Netherlands) | UvA-BiTS | 2013 | active |  |  |  | 
...
LBBG_IJMUIDEN - Lesser black-backed gulls (Larus fuscus, Laridae) in IJmuiden (the Netherlands) | UvA-BiTS | 2019 | active |  |  |  | 
LBBG_SCHIERMONNIKOOG - Lesser black-backed gulls (Larus fuscus, Laridae) in Schiermonnikoog (the Netherlands) | UvA-BiTS | 2017 | active |  |  |  | 
LBBG_TEXEL - Lesser black-backed gulls (Larus fuscus, Laridae) in Texel (the Netherlands) | UvA-BiTS | 2008 | active |  |  |  | 
