---
title: "Prepare GLobsl Messenger (GM) (meta)data for Movebank upload"
...
## Get GM tag and bird information from spreadsheet

```{r}
metadata <- readr::read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vS-JYMI6cnpA2csDxvIj94oQ_Q-fadLM1WnJhPRibTzCKQB73vRuInmsCJ2rzLLZfZUhI057iqoUIzr/pub?gid=0&single=true&output=csv")
...
movebank_ref_data <-
  ...
  dplyr::mutate(
    ...
    `tag-manufacturer-name` = "Global Messenger",
    `tag-mass` = tag_weight,
